...
// Report Problem dropdown component with spam protection

window.CartonApp = window.CartonApp || {};
window.CartonApp.Components = window.CartonApp.Components || {};

window.CartonApp.Components.ReportProblem = function () {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Your current configuration will be included automatically."
          )
        ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              {
                className: "text-xs bg-gray-50 p-2 rounded border border-gray-200 text-gray-600 break-all max-h-16 overflow-y-auto",
              },
